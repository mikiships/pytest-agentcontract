...
If no token is available, fall back to the available web search tool with `site:producthunt.com` queries.
...
2. Open specific Product Hunt URLs with the available URL fetch/open tool to get basic info
