...
Adapter modules ship with pytest-agentcontract. Your app still needs the framework package it uses; install `openai-agents` separately for the OpenAI Agents SDK adapter.
