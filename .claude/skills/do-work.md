...
- If the change touches public API (package exports such as `src/agentcontract/__init__.py`), note it
...
For CLI work: see `.claude/skills/steps/explore-ui.md`
...
- If adding public Python API, update the relevant package initializer exports
...
- Message describes what changed, not what you did ("fix: handle None in replay engine" not "updated file")
